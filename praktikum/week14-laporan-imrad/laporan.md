...
## Metode lingkungan uji, langkah eksperimen, parameter/dataset, cara pengukuran.
### Lingkungan Uji
- Bahasa Pemrograman : Python
- Sistem Operasi     : Windows 10
### Langkah Eksperimen
1. Menyiapkan dataset berupa reference string dan jumlah frame memori.
2. Mengimplementasikan algoritma FIFO untuk simulasi page replacement.
3. Mengimplementasikan algoritma LRU untuk simulasi page replacement.
4. Menjalankan simulasi untuk kedua algoritma dengan dataset yang sama.
5. Mencatat jumlah page fault untuk masing-masing algoritma.
### Parameter/Dataset
